<div>
    ...
    <x-main>
        ...
        <x-slot:content>
        @php
            $drivers = \App\Models\Parents::all();
        ...
        <x-header title="Parents" with-anchor separator />
        <x-button label="Add Parent" icon="o-plus" wire:click="openCreateModal" class="btn-primary" />
        ...
        <x-modal wire:model="editModal" title="Add Parent">
        ...
        <x-modal wire:model="addModal" title="Add Parent">
