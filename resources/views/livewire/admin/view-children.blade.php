<div>
    ...
    <x-main>
        ...
        <x-slot:content>
        @php
            $drivers = \App\Models\Children::all();
        ...
        <x-modal wire:model="addModal">
            <x-form wire:submit="create">
                ...
                <x-input wire:model="age" label="Age" />
        ...
        <x-modal wire:model="editModal" title="Update Child Details" >
            <x-form wire:submit="update">
                <x-input wire:model="name" label="Name" />
                <x-input wire:model="age" label="Age" />

                <x-slot:actions>
                    <x-button label="Cancel" wire:click="closeEditModal" class="btn-ghost" spinner="save" />
                    <x-button type="submit" label="Save" class="btn-primary" />
                </x-slot:actions>
            </x-form>
        </x-modal>
